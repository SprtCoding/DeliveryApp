...
public class inasal_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inasal_list);
        var();
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(inasal_list.this, 2);
        ...
        foodRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        if(food.getBranch().equals("Mang Inasal")){
                            foodModelList.add(food);
                        }
                    }
                    myAdapter = new JollyAdapter(inasal_list.this, foodModelList);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(inasal_list.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(inasal_list.this, customer_dashboard.class);
