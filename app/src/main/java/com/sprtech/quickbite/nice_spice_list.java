...
public class nice_spice_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nice_spice_list);
        var();
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(nice_spice_list.this, 2);
        ...
        foodRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        if(food.getBranch().equals("Nice & Spice")){
                            foodModelList.add(food);
                        }
                    }
                    myAdapter = new JollyAdapter(nice_spice_list.this, foodModelList);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(nice_spice_list.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(nice_spice_list.this, customer_dashboard.class);
