...
public class rotonda_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rotonda_list);
        var();
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(rotonda_list.this, 2);
        ...
        foodRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        if(food.getBranch().equals("Rotonda Cafe")){
                            foodModelList.add(food);
                        }
                    }
                    myAdapter = new JollyAdapter(rotonda_list.this, foodModelList);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(rotonda_list.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(rotonda_list.this, customer_dashboard.class);
