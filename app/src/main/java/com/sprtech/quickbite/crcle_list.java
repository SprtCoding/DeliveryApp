...
public class crcle_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crcle_list);
        var();
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(crcle_list.this, 2);
        ...
        foodRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        if(food.getBranch().equals("Thirst Zone")){
                            foodModelList.add(food);
                        }
                    }
                    myAdapter = new JollyAdapter(crcle_list.this, foodModelList);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(crcle_list.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(crcle_list.this, customer_dashboard.class);
