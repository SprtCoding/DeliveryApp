...
public class sizzling_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sizzling_list);
        var();
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(sizzling_list.this, 2);
        ...
        foodRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        if(food.getBranch().equals("Sizzling 99")){
                            foodModelList.add(food);
                        }
                    }
                    myAdapter = new JollyAdapter(sizzling_list.this, foodModelList);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(sizzling_list.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(sizzling_list.this, customer_dashboard.class);
